...
public class PopularServicesRecyclerViewAdapter extends RecyclerView.Adapter<PopularServicesRecyclerViewAdapter.ViewHolder> {
    ...
    public PopularServicesRecyclerViewAdapter(ClientHomeFragment ClientHomeFragment, ArrayList<Service> newsModalArrayList, Context context) {
    ...
    @NonNull
    @Override
    public PopularServicesRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new PopularServicesRecyclerViewAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.card_services, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull PopularServicesRecyclerViewAdapter.ViewHolder holder, int position) {
