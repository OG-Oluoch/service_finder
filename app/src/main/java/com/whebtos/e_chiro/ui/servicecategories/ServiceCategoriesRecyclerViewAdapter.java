...
public class ServiceCategoriesRecyclerViewAdapter extends RecyclerView.Adapter<ServiceCategoriesRecyclerViewAdapter.ViewHolder> {

    private ArrayList<ServiceCategory> arrayList;
    private Context context;
    private ServiceCategoriesFragment serviceCategoriesFragment;

    // creating a constructor.
    public ServiceCategoriesRecyclerViewAdapter(ServiceCategoriesFragment ServiceCategoriesFragment, ArrayList<ServiceCategory> newsModalArrayList, Context context) {
        this.serviceCategoriesFragment = ServiceCategoriesFragment;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                serviceCategoriesFragment.openServiceSubCategories(serviceCategory.getId());
            }
