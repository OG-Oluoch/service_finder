...
public class RecentServicesRecyclerViewAdapter extends RecyclerView.Adapter<RecentServicesRecyclerViewAdapter.ViewHolder> {
    ...
    public RecentServicesRecyclerViewAdapter(ClientHomeFragment ClientHomeFragment, ArrayList<Service> newsModalArrayList, Context context) {
    ...
    @NonNull
    @Override
    public RecentServicesRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new RecentServicesRecyclerViewAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.card_services, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull RecentServicesRecyclerViewAdapter.ViewHolder holder, int position) {
